REVOKE EXECUTE ON FUNCTION public.lookup_wallet_by_number(text) FROM anon;
REVOKE EXECUTE ON FUNCTION public.tx_execute_transfer(text, uuid, text, numeric, text, text, text, text) FROM anon;
